function [BO_window,AO0_window,AO1_window,AO2_window,AO3_window] = CompuWindow(pre_bin,bin_size)
% Computation window for responses in full length 
...
AO1_window=(pre_bin+100)/(bin_size*1000)+1:(pre_bin+850)/(bin_size*1000);     %% sustain response   (for all => 100 ~ 900or800)
