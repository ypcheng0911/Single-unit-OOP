function [F_ratio,spe_F_ratio,spe_std_F,Sig_F,peak_freq,peak_F] = speed_FFT_overlap_all_trials(filename01,filename02,tar_ch,tar_unit,cal_window,plot_ny,hide)
% try F1/F0 ratio
...
switch cal_window % on, sus, off, on+sus
    case 'on'
        skip_on = -0.05/bin;
        l_sti = 0.05/bin;
    case 'sus'
